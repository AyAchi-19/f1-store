      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <Card className="border-violet-200/50 shadow-lg shadow-violet-500/5">
            <CardHeader>
              <CardTitle className="text-2xl font-bold tracking-tight text-violet-950">Sign up</CardTitle>
              <CardDescription>Create a new account for F1 Store</CardDescription>
            </CardHeader>
            <CardContent>
