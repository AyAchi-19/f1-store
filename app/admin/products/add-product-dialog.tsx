  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-violet-600 hover:bg-violet-700 font-bold uppercase italic">
          <Plus className="mr-2 h-4 w-4" /> Add Product
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] rounded-3xl border-violet-100">
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input id="name" name="name" placeholder="e.g. Red Bull Cap" required className="border-violet-100" />
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input id="stock" name="stock" type="number" placeholder="50" required className="border-violet-100" />
              </div>
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid gap-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="border-violet-100 pr-10"
              ...
              <p className="text-xs text-slate-500">
                Paste valid image links separated by commas. The first image will be the main product image.
              </p>
            </div>

            {imageUrl && (
              <div className="group mt-2 relative rounded-xl overflow-hidden border border-violet-100 bg-slate-50 aspect-video shadow-sm">
                <img
                ...
                />
                <div className="absolute bottom-2 right-2 bg-black/70 text-white text-xs px-2 py-1 rounded-md backdrop-blur-md">
                  Preview
                </div>
              </div>
            )}
